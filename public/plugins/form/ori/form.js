...
steelblue:"4682b4",tan:"d2b48c",teal:"008080",thistle:"d8bfd8",tomato:"ff6347",turquoise:"40e0d0",violet:"ee82ee",wheat:"f5deb3",white:"fff",whitesmoke:"f5f5f5",yellow:"ff0",yellowgreen:"9acd32"},p;i.each("color,backgroundColor,borderColor,borderTopColor,borderBottomColor,borderLeftColor,borderRightColor,outlineColor".split(","),function(a,d){i.cssHooks[d]={set:function(a,c){a.style[d]=(new e(c)).getCSS()}};i.fx.passo[d]=function(a){if(k===a.xinit){if("string"===typeof a.end&&-1!==a.end.indexOf(";")){var c,
...
new Image,a.src=this.o.fallback);this.loop=function(){var b=c.o,d=0,g=1E3/b.fade/b.fps,n=c.passo,h=a.style,v="filter"in h&&b.fallback&&!l;return function(){3==c.phase&&(d-=g,0>=d&&(c.phase=0));1==c.phase&&(d+=g,1<=d&&(c.phase=2));if(v)h.filter="alpha(opacity="+e.min(100*b.alpha,e.max(0,Math.round(100*d)))+")";else if(!l&&b.fallback)h.opacity=d;else if(l){var a=c.ctx,s=n;t=1-d||0;q=1;r=-1;var f=b.size;!1===b.clockwise&&(q=-1,r=1);a.clearRect(0,0,f,f);a.globalAlpha=b.alpha;a.lineWidth=b.strokewidth;
...
4)},d));b.color=a;this.passo=b.lines;return this},start:function(){this.elem.style.display="block";-1==this.phase&&this.loop();this.phase=1;return this},stop:function(){this.phase=3;return this},toggle:function(){2==this.phase?this.stop():this.start()}}})(this);